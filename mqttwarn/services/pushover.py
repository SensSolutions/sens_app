...
CAFILE = "/usr/home/marck/mqttwarn/certs/GeoTrust_Global_CA.pem"
...
def pushover(**kwargs):
    ...
    _url = urlparse.urljoin(PUSHOVER_API, "messages.json")
    _data = urllib.unquote_plus(urllib.urlencode(kwargs))
#    req = urllib2.Request(url, data)
#    response = urllib2.urlopen(req)
#    print _url + "\n" + str(kwargs) +"\n"
#    print "URL : " + str(_url) + "\nDATA: " + _data + "\n    : " + str(kwargs) + "\n" 

    response = urllib2.urlopen(url=_url, cafile='certs/GeoTrust_Global_CA.pem', data = _data)
